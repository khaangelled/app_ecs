...
st.title("🖼️ Image with Split Bottom Line and Logos")
...
if uploaded_image:
    ...
    if image.width != image.height:
        st.warning("⚠️ Your image is not square (1:1 ratio). It will be center-cropped automatically to 1600×1600 pixels.")
